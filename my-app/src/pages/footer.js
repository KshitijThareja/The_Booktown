const Footer = () => {
    return (
        <footer className="p-6 dark:bg-black dark:text-white">
	<div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-3 ">
		<div className="flex flex-col space-y-5 mx-auto">
			...
			<div className="flex flex-col space-y-4 text-sm dark:text-white-400">
	...
	<div className="flex items-center justify-center px-6 pt-12 text-sm  ">
        <div className="flex flex-col space-y-2 text-sm dark:text-white-400">
        <div className=" border md:w-[145.31rem] h-[1.19rem] border-t-[0px] border-solid border-gray-700"></div>
		<div className="dark:text-white-400 text-center ">© Copyright 1986. All Rights Reserved.</div>
        </div>
	</div>
</footer>
