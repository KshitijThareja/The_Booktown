...
function MainNavigation() {
  ...
  return (
    <header className="border-b border-gray-200 bg-white py-2 block">
      <div className="flex items-center justify-between xl:max-w-8xl  max-w-full px-[8%] flex-wrap sm:flex md:flex">
        <img
            ...
            {user ? (
              ...
              <li>
                <Link href="/signup" passHref>
                  <button
                    className={`px-4 py-2 block bg-white text-black font-semibold border border-black cursor-pointer hover:bg-black hover:text-white hover:border-black mr-6 rounded-lg shadow hover:scale-110 ease-in duration-300 ${
                      open ? "mb-2 mt-2 " : ""
                    }`}
                  >
                    Sign up
            ...
            {user ? (
              ...
              <li>
                ...
                <Link href="/login" passHref>
                  <button
                    className={`px-5 py-2 block bg-black text-white font-semibold border border-black cursor-pointer hover:bg-white hover:text-black hover:border-black rounded-lg shadow hover:scale-110 ease-in duration-300 ${
                      open ? "my-2" : ""
                    }`}
                  >
                    Login
