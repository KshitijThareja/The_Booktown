    ...
    return (
        <header className="border-b border-gray-200 bg-white py-2 block">
            <div className="flex items-center justify-between xl:max-w-8xl xl:mx-auto max-w-full px-[8%] flex-wrap w-full">
                ...
                <FiMenu className="lg:hidden block h-6 w-6 md:justify-end cursor-pointer absolute right-0 mx" onClick={()=>setOpen(!open)} />
                <nav className={`w-full lg:flex lg:items-center lg:w-auto bg-white ${open ? "block" : "hidden"}`}>
                    <ul className=" text-base text-gray-500 lg:flex lg:justify-between list-none">
                        ...
                        <li>
                        <Link className="lg:px-5 py-2 block hover:text-darksalmon font-semibold hover:scale-110 ease-in duration-300" href="#">Contact</Link>
                        </li>
