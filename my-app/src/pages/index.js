  ...
  return (
    < div className="">
      ...
      <div className="mt-5 md:justify-self-end md:col-span-2">
        ...
        <h2 className="text-[2.04rem] justify-self-center text-center font-semibold mb-4 md:text-start">ABOUT US</h2>
      ...
      <div className="grid grid-cols-1 mt-5" />
            <div className="text-[3rem] font-semibold text-darksalmon inline-block">
