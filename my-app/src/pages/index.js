  ...
  return (
    ...
    <div>
      ...
      <div className="flex flex-row items-center justify-center min-w-screen px-2">
        ...
        <p className="[border:none] bg-[transparent] block font-montserrat text-[2.19rem] absolute top-[10.69rem] left-[13.25rem] w-[47.94rem] h-[26.56rem]">
          A world of books at <br /> your fingertips.
        </p>
        <p className="[border:none] bg-[transparent]  font-montserrat-thin  text-[1.19rem] absolute leading-[1.] top-[19.69rem] left-[13.25rem] w-[47.94rem] h-[26.56rem]">
        ...
        <img
          className="absolute top-[7.00rem] left-[72.65rem] rounded-tl-65xl rounded-tr-none rounded-br-none rounded-bl-65xl w-[46.25rem] h-[32.25rem] object-cover"
          alt=""
          src="/b8163268619025e9e0b33c10b504850b-1@2x.png"
        />
      </div>
      <div>
        <button className="absolute top-[29.56rem] left-[13.25rem] px-7 py-3 bg-black text-white font-semibold border border-black rounded cursor-pointer hover:bg-white hover:text-black hover:border-black">
          Donate Now
        </button>
        <button className="absolute top-[29.56rem] left-[25.75rem] px-7 py-3  bg-darksalmon shadow-[0px_4px_4px_rgba(0,_0,_0,_0.1)] border border-darksalmon rounded  text-white gap-[0.19rem] font-semibold  rounded-md cursor-pointer hover:bg-white hover:text-darksalmon ">
        Read More
        </button>
        </div>
    ...
    <div className="absolute top-[43.06rem] left-[49.5rem] text-[2.04rem] font-semibold inline-block w-[20.81rem] h-[4.31rem]">
      ...
      <ul className="space-y-3">
          ...
          <div className="absolute top-[97.69rem]  bg-mistyrose shadow-[0px_20px_44px_1px_rgba(0,_0,_0,_0.1)] w-[119rem] h-[31.13rem]" />
            <div className="absolute top-[99.25rem] left-[33.81rem] text-[3.88rem] font-semibold text-darksalmon inline-block w-[58.69rem] h-[4.31rem]">
